//
//  SeeReviewMoreImageCollectionViewCell.swift
//  MackDuck
//
...
class SeeReviewMoreImageCollectionViewCell: UICollectionViewCell {

    @IBOutlet weak var collectionImageView: UIImageView!
    
    static let identifier = "SeeReviewMoreImageCollectionViewCell"
    
    static func nib() -> UINib {
        return UINib(nibName: "SeeReviewMoreImageCollectionViewCell", bundle: nil)
    }
