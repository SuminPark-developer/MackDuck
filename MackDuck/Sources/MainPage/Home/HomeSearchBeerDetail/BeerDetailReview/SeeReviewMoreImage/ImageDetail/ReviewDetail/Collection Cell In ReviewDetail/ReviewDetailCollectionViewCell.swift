...
class ReviewDetailCollectionViewCell: UICollectionViewCell {
    ...
    static let identifier = "ReviewDetailCollectionViewCell"
    
    static func nib() -> UINib {
        return UINib(nibName: "ReviewDetailCollectionViewCell", bundle: nil)
    }
...
//        collectionImageView.isHidden = true
    ...
    public func configure(with imageUrl: ReviewDetailImgUrlList) {
