...
//            }
        ...
        print(introReviewModel.nickname)
        print("\(introReviewModel.age)/\(introReviewModel.gender)/\(beerKindString)")
...
//        }
        ...
        print(String(introReviewModel.score))
        ...
        print(introReviewModel.description)
