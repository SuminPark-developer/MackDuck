...
class AllReviewViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.allReviewDataManager.getAllReview(rowNumber: String(0), beerId: BeerData.details.beerId, delegate: self) // 모든 맥주 리뷰 정보 가져오는 api 호출,
    }
...
extension AllReviewViewController: UITableViewDataSource, UITableViewDelegate {
...
//         TODO: - 컬렉션뷰 연결 작업 필요.
        cell.configure(with: allReviewModel) // 리뷰안에 있는 컬렉션뷰에 데이터 전달.
