//
//  IntroReviewCollectionViewCell.swift
//  MackDuck
//
//  Created by sumin on 2022/01/25.
//

import UIKit

class IntroReviewCollectionViewCell: UICollectionViewCell {

    @IBOutlet weak var collectionImageView: UIImageView!
    
    static let identifier = "IntroReviewCollectionViewCell"
    
    static func nib() -> UINib {
        return UINib(nibName: "IntroReviewCollectionViewCell", bundle: nil)
    }
...
//        collectionImageView.isHidden = true
    ...
    public func configure(with model: IntroReviewModel) {
        
        for imageUrl in model.reviewImgUrlList {
