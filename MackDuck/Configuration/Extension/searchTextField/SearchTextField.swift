...
class SearchTextField: BaseTextField {
    private lazy var searchButton: UIButton = {
        let button = UIButton()
        button.setImage(#imageLiteral(resourceName: "magnifyingGlassYellow"), for: .normal)
...
//    }()
    ...
    override func configure() {
        ...
        attributedPlaceholder = NSAttributedString(string: "입력해주세요.",
        ...
        clearButtonMode = .never // clearButtonMode = .never로 설정해야 rightView에 view를 넣었을때 적용
